...
namespace VentoVox.Master
{
    public class BaseManager
    {
        ...
        public bool[] InitSequence()
        {
            ...
            AppMaster[(int)AppThread.WebManager] = new MasterController(iWebManager);
            ...
            HwMaster[(int)HWThread.HWManager] = new MasterController(iHWController);
            if (HwMaster != null)
            {
        ...
        public MasterController[] HwMaster = new MasterController[(int)HWThread.NUM_OF_HW_MANAGERS];

        public MasterController[] AppMaster = new MasterController[(int) AppThread.NUM_OF_APP_MANAGERS];
